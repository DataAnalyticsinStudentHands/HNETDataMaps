...
Template.compositeCampus.onCreated( function() {
  this.subscribe('compositeCampusDataSeries', function() {
  //this.subscribe( 'documents', function() {
...
// Template.compositeCampus.onRendered(function () {
//   // Do reactive stuff when something is added or removed
//   this.autorun(function () {
//     // Subscribe
//     Meteor.subscribe('compositeCampusDataSeries', startEpoch.get(), endEpoch.get());
//     Charts.remove({});
//
//     let initializing = true;
//
//     CompositeCampusDataSeries.find().observeChanges({
...
Template.compositeCampus.helpers({
  ...
  charts() {
    var data = CompositeCampusDataSeries.find();
    if (data) {
      return data;
        // const measurement = line._id.split(/[_]+/)[0];
        // const seriesData = line[0];
        // // store yAxis options in separate variable
        // const yAxisOptions = seriesData.yAxis;
        // delete seriesData.yAxis;
        //
  ...
  createChart() {
    const data = CompositeCampusDataSeries.find({});
...
console.log(chart)
        ...
        Meteor.defer(function() {
          ...
          Highcharts.StockChart(`container-chart-${chart._id}`, {
            exporting: {
              enabled: true
            },
            // chart: {
